...
const PROJECT_CARDS = [
    {
        ...
        title: 'Engine Immobilizer', subtitle: 'Remote immobilization for fleet managers responding to vehicle theft',
        desc: 'Remote immobilization for fleet managers responding to vehicle theft',
        tech: ['Blender', 'Figma', 'Origami Studio'],
        stats: { role: 'Product Design', impact: '+$8M to ARR', company: 'Motive' },
        objectType: 'truck_immobilizer',
        video: '/demos/ei-noborder.mp4',
        caseStudy: {
            meta: { role: 'Product Design', duration: '2 months', team: 'PM, Design Manager, VP of Design, 2 Engineering Managers' },
            sections: [
                {
                    type: 'intro',
                    label: 'THE PROBLEM',
                    title: 'Engine Immobilizer became a blocker',
                    body: 'I joined Motive in Q3 2023, right as plans to expand into Mexico were already in motion. Sales Engineers on the ground told us that 90% of prospects wanted remote immobilization. We had already lost one significant prospect because we did not have it. This was the only core requirement missing from our product offering. We backtracked on our priorities and had the rest of Q4 to figure it out for a Q1 2024 launch. Hardware, Tracking, and Platform all had to move together.',
                },
                {
                    type: 'role',
                    label: 'MY ROLE',
                    title: 'Leading the design',
                    body: 'I joined the Hardware team and partnered with Product Manager Nikhil Karanam to get the product to launch. The work crossed Hardware, Tracking, and Platform, with support from content, visual, and 3D design.',
                },
                {
                    type: 'research',
                    label: 'WHY THIS WAS HARD',
                    title: 'Major systematic updates were already in progress',
                    body: 'Admin was moving from 1.0 to 2.0. The Vehicles page had been designed for 2.0 but never built, while the 1.0 version kept collecting one-off additions. I had to strip the page down, rebuild its hierarchy, and add Engine Immobilizer without creating work that would be thrown away a few months later. Fleet View\'s maps, icons, and historical tracking were also changing. Device Hub was still only a plan. We could not build the hardware in-house, so Motive sourced a third-party device for the first time. Those decisions affected what data we could show, how the immobilizer paired with the Vehicle Gateway, and what happened when the signal was lost.',
                },
                {
                    type: 'images',
                    layout: 'pair',
                ...
                },
                {
                    ...
                    title: 'We tried five placements before choosing the banner',
                    body: 'I tried the action bar, below the vehicle status, beside the status, a dedicated section on the left, and a banner under the tabs. The banner would appear for less than 1% of vehicles at a time. If it was any quieter, it would be easy to miss. The first release handled starter-line immobilization. Fuel-line deceleration stayed on the roadmap for later.',
                },
                {
                    type: 'images',
                    layout: 'trio',
                    images: ['/case-material/iteration-4.png', '/case-material/iteration-1.png', '/case-material/iteration-final.png'],
                    caption: 'Iteration 1 (action button, top right) → Iteration 4 (dedicated section) → Final (persistent banner).',
                },
                {
                    type: 'features',
                    label: 'WHAT SHIPPED',
                    items: [
                        ...
                        { name: 'Live Tracking', desc: 'Location, live video, and follow mode for tracking a stolen vehicle. Immobilized vehicles appeared at the top of the fleet list.', video: '/demos/map-video.webm' },
                        { name: 'Trip Timeline', desc: 'Immobilization events appeared on the vehicle\'s trip timeline beside dashcam footage, helping fleets reconstruct what happened.', video: '/demos/vehicle-history.webm' },
                        { name: 'Tamper & Jammer Alerts', desc: 'After a customer call, I added alerts for physical device removal and signal jamming.', video: '/demos/notifications-video.webm' },
                    ],
                },
                {
                    type: 'research',
                    label: 'IMPACT',
                    title: 'Added $8M to Motive\'s ARR',
                    body: 'The product gave Sales the last core capability they needed for Mexico. It also lowered insurance premiums for fleets and helped reduce cargo theft. This was Motive\'s first third-party hardware product and my first project at the company.',
                    stat: '$8M ARR',
                },
                {
                    type: 'cta',
                    body: 'This is the short version. The full project also covered device assignment, dead-zone fallbacks, tamper and jammer alerts, and five UI iterations.',
                },
            ],
        },
    },
    {
        ...
        title: 'Workflows', subtitle: 'One place for engineering teams to write specs, assign work, request reviews, and track projects',
        desc: 'One place for engineering teams to write specs, assign work, request reviews, and track projects',
        tech: ['Figma', 'Microsoft Clarity', 'JavaScript', 'FigJam'],
        stats: { role: 'Product Designer', impact: 'Landed $100K Deal', company: 'Educative' },
        objectType: 'workflows',
        video: '/demos/wf-noborder.mp4',
        caseStudy: {
            meta: { role: 'Product Designer', duration: '8 months', team: 'CTO, 3 Product Managers, VP of Sales' },
            sections: [
                {
                    type: 'intro',
                    label: 'THE PROBLEM',
                    title: 'The scalability problem',
                    body: 'As our team at Educative scaled from 50 people to more than 600, a centralized repository for projects, communication, and documentation became necessary. The existing tools solved separate parts of the problem, requiring a lot of context switching and maintenance. To solve this for multiple personas across the company, we set out to build Workflows.',
                },
                {
                    type: 'role',
                    label: 'MY ROLE',
                    title: 'The Manager + IC Hybrid',
                    body: 'By this point, I had been at Educative for over two years. It was an ambitious product that our leadership was heavily focused on, and I worked directly with sales, engineering, and product leadership on the end-to-end process. I was also involved in hiring and developing an outcome-focused team of designers and illustrators.',
                },
                {
                    type: 'research',
                    label: 'RESEARCH',
                    title: 'Talking to the demographic',
                    body: 'I spoke to 31 people, including 18 Engineering Managers and 13 Software Engineers, sourced through my LinkedIn network. This was still exploratory, so I focused on how they used existing work-management tools, what they liked, what they did not, and where gaps existed. We found competitors across two main areas: documentation and project management.',
                },
                {
                    type: 'quotes',
                    label: 'KEY INSIGHTS',
                ...
                },
                {
                    ...
                    title: 'I built a functional wireframe over a weekend',
                    body: 'After synthesizing the findings and settling on the MVP features, I took a weekend to prototype a fully functional low-fidelity wireframe containing the core experience. It covered three touchpoints: Projects Home, Project Details, and the Document page. The first round of feedback showed that people needed clearer cues for where their attention was required, which tasks were due, and what they still needed to resolve.',
                },
                {
                    type: 'features',
                    label: 'FINAL DESIGNS',
                    items: [
                        { name: 'Task Manager', desc: 'I built a complete end-to-end task manager from scratch. Tasks were associated with projects and documents and could be assigned to anyone.', video: '/demos/task-page.webm' },
                        { name: 'Review Manager', desc: 'People could request reviews on their documents and track the process from request to resolution.', video: '/demos/reviews-video.webm' },
                        { name: 'Project Manager', desc: 'Projects grouped tasks and documents with due dates and collaborators.', video: '/demos/project-video.webm' },
                        { name: 'Document Editor', desc: 'This was the page where users spent most of their time. Tasks and reviews were part of the document, with states ranging from Not Started to Done.', video: '/demos/doc-video.webm' },
                    ],
                },
                {
                    type: 'research',
                    label: 'OUTCOME',
                    title: 'The work helped land a $100K deal',
                    body: 'Sales used a prototype built from these designs during the enterprise pitch.',
                    stat: '$100K deal',
                },
                {
                    type: 'cta',
                    body: 'This is the short version of an eight-month project. I can walk through the document model, review flows, and iterations in more detail.',
                },
            ],
        },
    },
